...
Recognition and translation drivers reconcile raw deltas, appends, and replacements into
...
caption stream, and their caption unit when the path has real units.
...
tricks stay inside the concrete driver.
