...
Numbers are stable identifiers, not priority rankings. New records append after
the current highest number; existing numbers are not reused or reordered. The
next ADR is 0023.
...
- [0019 — Reconnect within one runtime generation](./0019-reconnect-within-one-runtime-generation.md)
